-- Migration: Create global_system_prompts table and seed initial data

-- Create table
CREATE TABLE IF NOT EXISTS global_system_prompts (
...
CREATE INDEX IF NOT EXISTS idx_global_system_prompts_key ON global_system_prompts(key);
CREATE INDEX IF NOT EXISTS idx_global_system_prompts_active ON global_system_prompts(is_active);
